...
exports.linkConstraints = constraints
...
class JellyfishSDK {
   ...
   */
	 ...
	 * @param {Function} options.populate - Perform an initial query and send
	 *        the results as an array to this function. All cards in this array
	 *        become eligible for the `unmatch` event
	 *
	 * @fulfil {EventEmitter}
	 * @returns {Promise}
	 *
