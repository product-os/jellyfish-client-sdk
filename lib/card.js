...
class CardSdk {
	...
	/**
		 ...
		 * @returns {Promise<types.Contract>}
		 *
		 * @example
	...
	/**
		 ...
		 *
		 * @param {types.PartialContract} card - the contract to be created
		 *
	 ...
	 *
	 * @param {PartialContract} fromCard - The card that should be linked from
	 * @param {PartialContract} toCard - The card that should be linked to
