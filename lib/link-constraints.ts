...
export const constraints: LinkConstraint[] = [
	...
	{
		slug: 'link-constraint-commit-is-attached-to-pull-request',
		name: 'is attached to',
		data: {
			title: 'Pull Request',
			from: 'commit',
			to: 'pull-request',
			inverse: 'link-constraint-pull-request-has-attached-commit',
		},
	},
	{
		slug: 'link-constraint-pull-request-has-attached-commit',
		name: 'has attached',
		data: {
			title: 'Commit',
			from: 'pull-request',
			to: 'commit',
			inverse: 'link-constraint-commit-is-attached-to-pull-request',
		},
	},
	{
		slug: 'link-constraint-commit-has-attached-check-run',
		name: 'has attached',
		data: {
			title: 'Check Run',
			from: 'commit',
			to: 'check-run',
			inverse: 'link-constraint-check-run-is-attached-to-commit',
		},
	},
	{
		slug: 'link-constraint-check-run-is-attached-to-commit',
		name: 'is attached to',
		data: {
			title: 'Commit',
			from: 'check-run',
			to: 'commit',
			inverse: 'link-constraint-commit-has-attached-check-run',
		},
	},
	{
